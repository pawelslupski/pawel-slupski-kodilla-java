...
public class BoardTestSuite {
    ...
    public void testAddTaskListFindUsersTasks() {
        ...
        List<Task> tasks;
        tasks = project.getTaskLists().stream()
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        inProgresssTasks.add(new TaskList("In progress"));
                        long theDaysBetweenResult = project.getTaskLists().stream()
                        ...
                        long theNumberOfElements = project.getTaskLists().stream()
                                .filter(inProgresssTasks::contains)
                                .flatMap(tl -> tl.getTasks().stream())
                                .count();

                        double theDaysBetweenResultDouble = (double) theDaysBetweenResult;
                        double theNumberOfElementsDouble = (double) theNumberOfElements;

                        double theAverageOfDaysPerTask = theDaysBetweenResultDouble / theNumberOfElementsDouble;
        //Then
        Assert.assertEquals(30, theDaysBetweenResult);
