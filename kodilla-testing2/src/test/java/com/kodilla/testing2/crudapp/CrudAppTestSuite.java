...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://pawelslupski.github.io/";
    ...
    private boolean checkTaskExitsInTrello(String taskName) throws InterruptedException {
        final String TRELLO_URL = "https://trello.com/login";
        boolean result = false;
        WebDriver driverTrello = WebDriverConfig.getDriver(WebDriverConfig.CHROME);
        driverTrello.get(TRELLO_URL);

        driverTrello.findElement(By.id("user")).sendKeys("Speco2006@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Guenlon10");
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        assertTrue(checkTaskExitsInTrello(taskName));
